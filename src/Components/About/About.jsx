      ...
      <div className="about-sections">
        ...
        <div className="about-right">
          <div className="about-para">
            <p>
              I am an experienced full stack developer with more than 3 years of
              profesional expertise in the field. Througout my career i have had
          ...
          <div className="about-skills">
            ...
            <div className="about-skill">
              <p>Spring Boot</p> <hr style={{ width: "70%" }} />
            </div>
          </div>
        </div>
      </div>
